...
module.exports.update = async (req, res, next) => {
  ...
  try{
    ...
    const getDealIdAndDetailIdx = await dealComHandler.multipleGet(goodsIdx)
...
module.exports.delete = async (req, res, next) => {
  ...
  try {
    ...
    const dealResult = await dealHandler.multipleDelete({id_array: goodsIdArray}, connection);
    const dealComResult = await dealComHandler.multipleDelete({id_array: goodsIdArray}, connection);
